...
var ParseServer = function () {
  function ParseServer(_ref) {
    var _ref$appId = _ref.appId,
        ...
        push = _ref.push,
        _ref$scheduledPush = _ref.scheduledPush,
        scheduledPush = _ref$scheduledPush === undefined ? false : _ref$scheduledPush,
      ...
      passwordResetSuccess: undefined
        ...
        _ref$cacheTTL = _ref.cacheTTL,
        cacheTTL = _ref$cacheTTL === undefined ? _defaults2.default.cacheTTL : _ref$cacheTTL,
        _ref$cacheMaxSize = _ref.cacheMaxSize,
        cacheMaxSize = _ref$cacheMaxSize === undefined ? _defaults2.default.cacheMaxSize : _ref$cacheMaxSize,
        ...
        _ref$objectIdSize = _ref.objectIdSize,
        objectIdSize = _ref$objectIdSize === undefined ? _defaults2.default.objectIdSize : _ref$objectIdSize,
  ...
  _createClass(ParseServer, [{
    ...
    value: function handleShutdown() {
      var adapter = this.config.databaseController.adapter;
    ...
    value: function promiseRouter(_ref3) {
      ...
      var routers = [new _ClassesRouter.ClassesRouter(), new _UsersRouter.UsersRouter(), new _SessionsRouter.SessionsRouter(), new _RolesRouter.RolesRouter(), new _AnalyticsRouter.AnalyticsRouter(), new _InstallationsRouter.InstallationsRouter(), new _FunctionsRouter.FunctionsRouter(), new _SchemasRouter.SchemasRouter(), new _PushRouter.PushRouter(), new _LogsRouter.LogsRouter(), new _IAPValidationRouter.IAPValidationRouter(), new _FeaturesRouter.FeaturesRouter(), new _GlobalConfigRouter.GlobalConfigRouter(), new _PurgeRouter.PurgeRouter(), new _HooksRouter.HooksRouter(), new _CloudCodeRouter.CloudCodeRouter(), new _AudiencesRouter.AudiencesRouter()];
